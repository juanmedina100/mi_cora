...
Padding historyHorizontal(BuildContext context) {
  TransactionProvider myProvider = context.watch<TransactionProvider>();
  return Padding(
        padding: const EdgeInsets.all(8.0),
        child: myProvider.transactions.length > 0 ? GridView.builder(
          ...
          ,itemBuilder: (context,Index,){
            return Card(
              child: ListTile(
                ...
                textAlign: TextAlign.start,style: TextStyle(fontSize: 16),maxLines: 1, overflow: TextOverflow.ellipsis),
                    Text(myProvider.transactions[Index].fecha.toString(),
                textAlign: TextAlign.center,style: TextStyle(fontSize: 14),),
                    Container(
                      width: double.infinity,
                      child: Text(myProvider.transactions[Index].categoria.toString(),
